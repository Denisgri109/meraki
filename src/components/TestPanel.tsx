...
const SEED_ACTIONS: SeedAction[] = [
    // Bookings
    { id: 'appt-pending', label: 'Booking — Pending', description: 'Create pending appointment in 1 hour', icon: 'event', category: 'Bookings', action: 'create_appointment', params: { status: 'pending', when: 'future', minutes_offset: 60 } },
    { id: 'appt-confirmed', label: 'Booking — Confirmed', description: 'Create confirmed appointment tomorrow', icon: 'event-available', category: 'Bookings', action: 'create_appointment', params: { status: 'confirmed', when: 'future', minutes_offset: 1440 } },
    { id: 'appt-completed', label: 'Booking — Completed', description: 'Past appointment, marked completed', icon: 'check-circle', category: 'Bookings', action: 'create_appointment', params: { status: 'completed', when: 'past', minutes_offset: -1440 } },
    { id: 'appt-cancelled', label: 'Booking — Cancelled', description: 'Cancelled appointment', icon: 'event-busy', category: 'Bookings', action: 'create_appointment', params: { status: 'cancelled', when: 'future', minutes_offset: 240 } },

    // Consultations
    { id: 'photo-consult-pending', label: 'Photo Consult — Pending', description: 'Client requests a photo consult', icon: 'photo-camera', category: 'Consultations', action: 'create_photo_consultation', params: { status: 'pending' } },
    { id: 'photo-consult-responded', label: 'Photo Consult — Responded', description: 'Photo consult with master reply', icon: 'mark-chat-read', category: 'Consultations', action: 'create_photo_consultation', params: { status: 'responded', master_reply: 'Yes, totally doable! Estimated 2 hours.' } },
    { id: 'booking-consult-pending', label: 'Booking Consult — Pending', description: 'Pre-booking consultation', icon: 'fact-check', category: 'Consultations', action: 'create_booking_consultation', params: { status: 'pending' } },
    { id: 'booking-consult-approved', label: 'Booking Consult — Approved', description: 'Pre-booking consultation approved', icon: 'verified', category: 'Consultations', action: 'create_booking_consultation', params: { status: 'approved' } },
    ...
    // Cleanup
    { id: 'clear-all', label: 'Clear ALL test data', description: 'Delete all test bookings, consults, chats, orders. Reset loyalty.', icon: 'delete-forever', category: 'Cleanup', action: 'clear_test_data', destructive: true },
];
