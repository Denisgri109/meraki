                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <View style={{ flex: 1 }}>
                                <MerakiText style={styles.profileName}>{profile?.full_name || 'Master'}</MerakiText>
                    ...
                    <View style={styles.quickGrid}>
                        {[
                            { icon: 'event-note', label: 'Schedule', desc: 'Manage schedule', route: 'Schedule' },
                            { icon: 'photo-library', label: 'Portfolio', desc: 'Your work', route: 'Portfolio' },
                            { icon: 'room-service', label: 'My Services', desc: 'Service catalog', route: 'MyServices' },
                            { icon: 'schedule', label: 'Availability', desc: 'Set hours', route: 'Availability' },
                            { icon: 'account-balance-wallet', label: 'Earnings', desc: 'Track income', route: 'Earnings' },
